...
from src.solid.isp.correspond.lib.audiobook.interface_borrowable_audiobook import BorrowableAudioBookInterface


class AudioBook(BorrowableAudioBookInterface ):
